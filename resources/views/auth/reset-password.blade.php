...
<head>
    ...
    <title>Create New Password - Studio CRM</title>
...
<body class="flex items-center justify-center min-h-screen p-6">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div class="p-8 text-center">
            ...
            <p class="text-slate-500 text-sm mb-8">Your new password must be different from previous used passwords.</p>

            @if($errors->any())
                <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 flex items-start gap-3">
                    <i class="fas fa-exclamation-circle text-red-500 mt-0.5"></i>
                    <div class="text-left">
                        <h4 class="text-sm font-bold text-red-800">Validation Error</h4>
            ...
            <form action="{{ route('password.update') }}" method="POST" class="text-left">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="email" name="email" value="{{ request()->email ?? old('email') }}" required readonly
                            class="w-full pl-11 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-100 text-gray-500 focus:outline-none transition-all font-medium cursor-not-allowed">
                    </div>
                </div>
                ...
                <div class="mb-8">
                    <label class="block text-xs font-bold text-slate-500 uppercase mb-2 ml-1">Confirm Password</label>
                    <div class="relative">
                        <span class="absolute left-4 top-3.5 text-gray-400"><i class="fas fa-check-circle"></i></span>
