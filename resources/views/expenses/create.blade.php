...
<style>
    /* Customizing Flatpickr to match your screenshot clean look */
...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="px-8 py-5 border-b border-gray-100">
            <h3 class="font-bold text-lg text-slate-800">New Expense Details</h3>
        </div>

        <form action="{{ route('expenses.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="1" name="amount" placeholder="0" required 
                ...
                <div class="md:col-span-2">
                    ...
                    <input list="expense-titles" name="title" placeholder="e.g. Uber to Client Meeting" required 
                ...
                <div class="md:col-span-2" x-data="{ fileName: 'No file selected.' }">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" rows="2" class="w-full rounded-lg border border-gray-200 py-2.5 px-3 focus:border-blue-500 focus:ring-blue-500"></textarea>
                </div>
